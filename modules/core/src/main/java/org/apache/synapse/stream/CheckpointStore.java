...
/**
 * Durable, append-only storage for one operator's {@link Checkpoint}s.
 * <p>
 ...
 *   2. confirm it landed      (output is durable)
...
public interface CheckpointStore {
     ...
     * <p>
     * A partially written trailing entry is discarded, not reported — that is the append-only log
     * working as intended.
     *
